...
from nodes import start_message,call_model,summarizer,grading,cheatingcheck,ending,human_answer,should_continue_interview,wait_for_answer_node
from states import State

builder = StateGraph(State)

builder.add_node("start interview", start_message)
builder.add_node("question generate", call_model)
...
builder.add_edge("start_message", "question generate")
builder.add_edge("question generate","human_answer")
